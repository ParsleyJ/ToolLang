...
public class ToolInteger extends ToolObject {
    ...
    public static List<ToolMethod> getNativeInstanceMethods() {
        return Arrays.asList(
                new CBONativeInstanceMethod<ToolInteger>("_asterisk_", BaseTypes.C_INTEGER, "x",
                        (a,b,mem) -> new ToolInteger(a.getInteger() * b.getInteger())),
                new CBONativeInstanceMethod<ToolInteger>("_slash_", BaseTypes.C_INTEGER, "x",
                        (a,b,mem) -> {
                            if((b.getInteger() == 0)) throw new ToolArithmeticException("Division by zero.");
                            return new ToolInteger(a.getInteger() / b.getInteger());
                        }),
                new CBONativeInstanceMethod<ToolInteger>("_percentSign_", BaseTypes.C_INTEGER, "x",
                        (a,b,mem) -> {
                            if((b.getInteger() == 0)) throw new ToolArithmeticException("Division by zero.");
                            return new ToolInteger(a.getInteger() % b.getInteger());
                        }),
                new CBONativeInstanceMethod<ToolInteger>("_plus_", BaseTypes.C_INTEGER, "x",
                        (a,b,mem) -> new ToolInteger(a.getInteger() + b.getInteger())),
                new CBONativeInstanceMethod<ToolInteger>("_minus_", BaseTypes.C_INTEGER, "x",
                        (a,b,mem) -> new ToolInteger(a.getInteger() - b.getInteger()))
        );
    }
